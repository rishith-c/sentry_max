    ...
    extend: {
      colors: {
        ...
        verification: {
          ...
          crews: "hsl(var(--verification-crews))",
          prescribed: "hsl(var(--verification-prescribed))",
          industrial: "hsl(var(--verification-industrial))",
        },
        fire: {
          ember: "hsl(var(--fire-ember))",
          flame: "hsl(var(--fire-flame))",
          smoke: "hsl(var(--fire-smoke))",
          char: "hsl(var(--fire-char))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
